...
import { cn, convertDate, dateToMilliseconds, formatDate, formatNumberToFrenchStandard, MStatus } from "@/lib/utils";
...
export const columns: ColumnDef<IDocumentFacture>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="capitalize">{row.original.entete.DO_TotalHT}</div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <>
        <div className="capitalize">{row.original.entete.DO_TotalTVA}</div>
      </>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <>
        <div className="capitalize">{row.original.entete.DO_TotalTTC}</div>
      </>
    ),
  }
];
