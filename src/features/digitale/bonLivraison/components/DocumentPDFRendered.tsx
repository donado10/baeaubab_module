...
export const DocumentPDFFactureResumeContainer = ({ documents, agence }: { documents: IDocumentBonLivraison[], agence: IAgence }) => {
...
export function DocumentPDFFactureResume({ agence, documents }: { agence: IAgence, documents: IDocumentBonLivraison[] }) {
